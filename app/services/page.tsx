...
const galleryRow1 = [
  { src: '/images/painting.webp', alt: 'Interior painting project by A&N in Houston TX', orientation: 'horizontal' as const },
  { src: '/images/kitchen.webp', alt: 'Kitchen renovation completed by A&N Painting and Renovations Houston', orientation: 'horizontal' as const },
  { src: '/images/full_home.webp', alt: 'Full home renovation project in Houston TX', orientation: 'vertical' as const },
  { src: '/images/hero-v2.jpeg', alt: 'Exterior house painting in Houston by A&N', orientation: 'horizontal' as const },
  { src: '/images/background.webp', alt: 'Home remodeling project completed in Houston TX', orientation: 'vertical' as const },
];

const galleryRow2 = [
  { src: '/images/full_home.webp', alt: 'Whole home renovation by A&N Painting and Renovations', orientation: 'vertical' as const },
  { src: '/images/hero-v2.jpeg', alt: 'Professional house painting Houston TX', orientation: 'horizontal' as const },
  { src: '/images/painting.webp', alt: 'Interior wall painting by Houston contractor A&N', orientation: 'horizontal' as const },
  { src: '/images/kitchen.webp', alt: 'Custom kitchen remodel in Houston TX', orientation: 'vertical' as const },
  { src: '/images/background.webp', alt: 'Residential renovation in Houston by A&N Painting', orientation: 'horizontal' as const },
];
    ...
    <div className="relative bg-black text-white">
        ...
        <div className="relative z-20 border-t border-b border-white/10 bg-neutral-900/80 backdrop-blur-md">
          <div className="grid grid-cols-3 divide-x divide-white/10">
            {[
              ...
              <a key={s.label} href={s.href} className="flex flex-col items-center justify-center gap-2 py-6 sm:py-7 text-blue-400 hover:bg-white/5 hover:text-blue-300 transition-all group">
                <s.icon className="h-6 w-6 sm:h-7 sm:w-7 text-blue-500 group-hover:text-blue-400 transition-colors" />
                <span className="text-xs sm:text-sm font-bold uppercase tracking-wider">{s.label}</span>
              </a>
            ))}
          </div>
        </div>
        ...
        <div className={shell}>
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white tracking-tight">
              What We <span className="text-blue-500">Do Best</span>
            </h2>
      ...
      <section id="gallery" className="py-16 md:py-20 bg-neutral-950 overflow-hidden">
        ...
        <div className="relative mb-4">
          <div className="flex gap-4 animate-[scrollLeft_40s_linear_infinite]" style={{ width: 'max-content' }}>
            {[...galleryRow1, ...galleryRow1].map((img, i) => (
              <div key={i} className={`relative shrink-0 rounded-xl overflow-hidden ${img.orientation === 'vertical' ? 'w-52 sm:w-64 aspect-[3/4]' : 'w-72 sm:w-80 aspect-[4/3]'}`}>
                <NextImage
                  src={img.src}
                  alt={img.alt}
                  fill
                  ...
                  quality={80}
                  sizes={img.orientation === 'vertical' ? '(max-width: 640px) 208px, 256px' : '(max-width: 640px) 288px, 320px'}
                />
              </div>
            ))}
          </div>
        ...
        <div className="relative">
          <div className="flex gap-4 animate-[scrollRight_45s_linear_infinite]" style={{ width: 'max-content' }}>
